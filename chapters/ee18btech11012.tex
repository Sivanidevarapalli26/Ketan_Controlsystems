...
\solution Fig.1.0.1; models the equivalent of compensated closed loop system. 
 \begin{figure}[!ht]
	\begin{center}
		\resizebox{\columnwidth}{!}{\input{name.tex}}
	\end{center}
\caption{}
\label{fig:1;}
\end{figure}
...
\begin{figure}[!h]
\centering
  \includegraphics[width=1.5\columnwidth]{ee18btech11012_2.eps}
\caption{}
...
\begin{figure}[!h]
\centering
  \includegraphics[width=\columnwidth]{ee18btech11012_3.eps}
\caption{}
\label{fig:2} 
\end{figure}
...
\begin{table}[!ht]
\centering
\input{ee18btech11012_table1.tex}
